			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="login2" method="post">
							<input name="email" type="email" size= "75" placeholder="E-mail" />
							${errorlogin}
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="data"  name="frm" method="post">
						<table>
						
						<tr><td><input type="text"  size="75" name="uname" placeholder="Name"  autofocus required /></td></tr>
							
							<tr><td><input type="email" name="email" placeholder="Email Address" required /></td><td>${error}</td></tr> 
							
							<tr><td><input id="pass1" type="password" name="password" placeholder="Password" required/></td></tr>
							<tr><td><input id="pass2" type="password" name="cpassword" placeholder="Confirm Password" required/></td></tr>
							<tr><td><textarea name="address" rows="4" cols="20" placeholder="Address" required></textarea></td></tr>
							

							<tr><td><input type="text" name="mobile" placeholder="Mobile Number" required/></td></tr>
							<tr><td><button type="submit" onclick="return val()" class="btn btn-default">Signup</button></td></tr>
							</table>
						</form>
					</div><!--/sign up form-->
				</div>  
